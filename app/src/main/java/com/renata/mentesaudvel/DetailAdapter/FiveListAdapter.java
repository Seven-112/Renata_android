...
public class FiveListAdapter extends RecyclerView.Adapter<FiveListAdapter.MyViewHolder> {
    ...
    public FiveListAdapter(FiveDetailList FiveDetailList, String[] itemname, String[] titlename) {
    ...
    @NonNull
    @Override
    public FiveListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View itemView = inflater.inflate(R.layout.slide_list, parent, false);
        return new FiveListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull FiveListAdapter.MyViewHolder holder, final int position) {
