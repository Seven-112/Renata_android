...
public class SlideListAdapter extends RecyclerView.Adapter<SlideListAdapter.MyViewHolder> {

    private final String[] itemname;
    private final String[] titlename;
    TextView extratxt, titletxt;
    ImageView readStatus, bookmark, copyToClipboard, colorChange, txtFamily;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(View view) {
            ...
            screen = (RelativeLayout) view.findViewById(R.id.backColor);
            colorChange = (ImageView) view.findViewById(R.id.backChange);
            txtFamily = (ImageView) view.findViewById(R.id.textFamily);
    ...
    public SlideListAdapter(OneDetailList OneDetailList, String[] itemname, String[] titlename) {
    ...
    @NonNull
    @Override
    public SlideListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View itemView = inflater.inflate(R.layout.slide_list, parent, false);
        return new SlideListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final SlideListAdapter.MyViewHolder holder, final int position) {
        extratxt.setText(itemname[position]);
        titletxt.setText(titlename[position]);
        Log.v("all id", String.valueOf(position));
        ...
        colorChange.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                screen.setBackgroundColor(Color.parseColor("#ff00ff"));
                Log.v("id", String.valueOf(position));
            }
        });
