...
public class FourListAdapter extends RecyclerView.Adapter<FourListAdapter.MyViewHolder> {
    ...
    public FourListAdapter(FourDetailList FourDetailList, String[] itemname, String[] titlename) {
    ...
    @NonNull
    @Override
    public FourListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View itemView = inflater.inflate(R.layout.slide_list, parent, false);
        return new FourListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull FourListAdapter.MyViewHolder holder, final int position) {
