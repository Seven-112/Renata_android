...
public class EightListAdapter extends RecyclerView.Adapter<EightListAdapter.MyViewHolder> {
    ...
    public EightListAdapter(EightDetailList EightDetailList, String[] itemname, String[] titlename) {
    ...
    @NonNull
    @Override
    public EightListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View itemView = inflater.inflate(R.layout.slide_list, parent, false);
        return new EightListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull EightListAdapter.MyViewHolder holder, final int position) {
