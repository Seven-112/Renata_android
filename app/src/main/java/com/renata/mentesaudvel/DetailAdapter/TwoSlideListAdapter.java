...
public class TwoSlideListAdapter extends RecyclerView.Adapter<TwoSlideListAdapter.MyViewHolder> {
    ...
    public TwoSlideListAdapter(TwoDetailList TwoDetailList, String[] itemname, String[] titlename) {
    ...
    @NonNull
    @Override
    public TwoSlideListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View itemView = inflater.inflate(R.layout.slide_list, parent, false);
        return new TwoSlideListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull TwoSlideListAdapter.MyViewHolder holder, final int position) {
