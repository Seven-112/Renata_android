...
public class SevenListAdapter extends RecyclerView.Adapter<SevenListAdapter.MyViewHolder> {
    ...
    public SevenListAdapter(SevenDetailList SevenDetailList, String[] itemname, String[] titlename) {
    ...
    @NonNull
    @Override
    public SevenListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View itemView = inflater.inflate(R.layout.slide_list, parent, false);
        return new SevenListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SevenListAdapter.MyViewHolder holder, final int position) {
