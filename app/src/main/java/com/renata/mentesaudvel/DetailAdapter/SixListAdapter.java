...
public class SixListAdapter extends RecyclerView.Adapter<SixListAdapter.MyViewHolder> {
...
class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public SixListAdapter(SixDetailList SixDetailList, String[] itemname, String[] titlename) {
    ...
    @NonNull
    @Override
    public SixListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);
        View itemView = inflater.inflate(R.layout.slide_list, parent, false);
        return new SixListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SixListAdapter.MyViewHolder holder, final int position) {
