...
public class MessageAdminAdapter extends RecyclerView.Adapter<MessageAdminAdapter.MessageViewHolder> {
    private List<Messages> userMessageList;
    private FirebaseAuth mAuth;
    private DatabaseReference usersRef;

    public MessageAdminAdapter(List<Messages> userMessageList){
    ...
    @NonNull
    @Override
    public MessageAdminAdapter.MessageViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_message_personal, viewGroup, false);
        mAuth = FirebaseAuth.getInstance();
        return new MessageAdminAdapter.MessageViewHolder(view);
    }



    @Override
    public void onBindViewHolder(@NonNull final MessageAdminAdapter.MessageViewHolder messageViewHolder, int i) {
